...
#define XHDI_CLOBBER_LIST	"d1", "a0", "a1", "memory"
...
({	\
	...
	__asm__ volatile (	\
		...
		"lea	sp@(10),sp"	\
		: "=r"(retvalue)	\
		: "a"(cookie), "g"(n), "g"(p1), "g"(p2), "g"(p3), "g"(p4)	\
		: XHDI_CLOBBER_LIST	\
	);	\
	retvalue;	\
})
...
({	\
	...
	__asm__ volatile (	\
		...
		"lea	sp@(18),sp"	\
		: "=r"(retvalue)	\
		: "a"(cookie), "g"(n), "g"(p1), "g"(p2), "g"(p3), "g"(p4), "g"(p5)	\
		: XHDI_CLOBBER_LIST	\
	);	\
	retvalue;	\
})
...
({	\
	...
	__asm__ volatile (	\
		...
		"lea	sp@(18),sp"	\
		: "=r"(retvalue)	\
		: "a"(cookie), "g"(n), "g"(p1), "g"(p2), "g"(p3), "g"(p4), "g"(p5), "g"(p6)	\
		: XHDI_CLOBBER_LIST	\
	);	\
	retvalue;	\
})
...
({	\
	...
	__asm__ volatile (	\
		...
		"lea	sp@(28),sp"	\
		: "=r"(retvalue)	\
		: "a"(cookie), "g"(n), "g"(p1), "g"(p2), "g"(p3), "g"(p4), "g"(p5), "g"(p6), "g"(p7)	\
		: XHDI_CLOBBER_LIST	\
	);	\
	retvalue;	\
})
